...
class Frame(object):
    ...
    def __init__(self,
                 dest=None, orig=None, t_id=None, cmde=None, status=None,
                 *argv):
        """
    ...
    def frame_update(fr):
        ...
        return Frame.frame(fr.dest, fr.orig, fr.t_id, fr.cmde, fr.stat,
                           fr.argv)
    ...
    def frame(dest, orig, t_id=None, cmde=None, stat=None, *argv):
        ...
        if cmde in dc:
            e = '%s(%s, %s, %s, %s, ' % (
                dc[cmde].__name__, dest, orig, t_id, stat)
            argv = argv[0]
...
class i2c_read(Frame):
    ...
    def __init__(self, dest, orig, t_id, stat, *argv):
        super(self.__class__, self).__init__(
            dest, orig, t_id, self.__class__.cmde, stat, *argv)
...
def test():
    ...
    f = frame(0x00, 0x01, 0x11, Frame.RESP | Frame.TIME_OUT, 0x00,
              7, 8, 9, 10, 11
              )
    print(f)
...
def usage():
    """
    generate .c and .h files from the description given in frame.py
    and optionnaly from frame_specific.py if it exists

    usage:
        ./frame.py <C file name> <H file name>
    """
